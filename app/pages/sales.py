...
class SalesPage:
    """Página principal de análise de vendas."""
    ...
    def render(self) -> None:
        ...
        # Calcular métricas
        total_sales = self.metrics_calculator.calculate_total(
            filtered_df, 
            'quantidade'
        )
        
        ytd_sales = self.metrics_calculator.calculate_ytd(
            filtered_df,
            'quantidade'
        )
        ...
        self.metrics_component.render_sales_metrics(
        ...
        self.chart_component.render_sales_trend_chart(
            df=weekly_data,
...
def main():
    ...
    st.set_page_config(
        page_title="Forecast Venus - Vendas",
        page_icon="📊",
        layout="wide",
